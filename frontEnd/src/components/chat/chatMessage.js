...
const ChatMessage = ({ messageObject }) => {
  if (
    !messageObject ||
    messageObject.person === null ||
    messageObject.person === undefined
  ) {
    return null;
  }
      ...
      case "rollMessage":
        return (
          <div className={"roll-message"}>
            {messageObject.person} rolled a {messageObject.num}
          </div>
        );
      case "disconnected":
        return (
          <div className={"disconnect-message"}>
            {messageObject.person} has left
          </div>
        );
      case "connected":
        return (
          <div className={"connect-message"}>
            {messageObject.person} has joined
          </div>
        );
      default:
  ...
  return formatMessage(messageObject);
};
